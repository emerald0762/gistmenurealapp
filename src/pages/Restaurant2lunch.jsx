...
export default function Restaurant2Lunch() {
  ...
  return (
    <Stack direction="row" spacing={20} sx={{justifyContent: "space-evenly", alignItems: "center"}} >
     <Button variant="text" onClick={() => navigate('/restaurant2breakfast')} sx={{color: '#000000', fontSize:'3rem'}}>아침</Button>
     ...
     <Button variant="text" onClick={() => navigate('/restaurant2dinner')} sx={{color: '#000000', fontSize:'3rem'}}>저녁</Button>
